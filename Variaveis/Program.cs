...
namespace Variaveis
{
    internal class Program
    {
        ...
        static void Main(string[] args)
        {
            ...
            //float real1 = 100.75f; // 32 bits, intervalo de 1,5 x 10-45 a 3,4 x 1038, precisão de 7 dígitos => Sufixo f, Ex.: 10.5f
            //double real2 = 12500.45; // 64 bits, intervalo de 5,0 x 10-324 a 1,7 x 10308, precisão de 15 dígitos => Sufixo d (opcional), Ex.: 10.5d
            //decimal real3 = 752538.457m; // 128 bits, intervalo de -7,9 x 10-28 a 7,9 x 1028, precisão de 28 dígitos => Sufixo m, Ex.: 10.5m
